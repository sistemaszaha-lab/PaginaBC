...
class OperacionesPanelFiltroUsuariosTests(TestCase):
    ...
    def test_panel_conserva_la_estructura_del_tablero_kanban(self):
        ...
        self.assertContains(resp, 'data-operaciones-user-filter-apply="1"')
...
class OperacionesInlineCreateTests(TestCase):
    ...
    def test_javascript_evitar_insertar_tarjeta_ajena_al_filtro_activo(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn("function applyAssignedUserFilter()", javascript)
        ...
        self.assertIn("card.classList.toggle('operacion-user-filter-hidden', !shouldShow);", javascript)
        self.assertIn("document.addEventListener('click', (e) => {", javascript)
        self.assertIn("const applyFilterButton = e.target.closest('[data-operaciones-user-filter-apply=\"1\"]');", javascript)
        self.assertIn("applyAssignedUserFilter();", javascript)
        ...
        self.assertNotIn("root.addEventListener('click', (e) => {\n      const applyFilterButton = e.target.closest('[data-operaciones-user-filter-apply=\"1\"]');", javascript)
